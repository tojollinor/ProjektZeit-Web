...
- Arbeitszeitmodell: pro Mitarbeiter wahlweise ab jetzt oder rückwirkend ab Datum, tägliches/wöchentliches/monatliches Soll, ausgewählte, gleichmäßig gewichtete Arbeitstage; Monatsverteilung schließt Feiertage ein; Gutschrift erst am abgeschlossenen Tag, Feiertagsarbeit zusätzlich; Sekunden ohne Rundungsverlust. Rückdatierungen dürfen keine abgeschlossenen Monate verändern.
...
- Buchhaltung: Mitarbeiterkonto und Kundenabrechnung unabhängig; gefilterte Mitarbeiterübersicht mit Kennzahlen, Kontobewegungen, Abschlussverlauf und CSV-Export; Auszahlungen und Storno, Monatsabschluss und begründetes Wiederöffnen; Pflicht-Leistungstext gegliedert nach Leistungsdatum/Nachname/Vorname, keine automatische Rechnung.
...
- Notdienst: wiederholender Plan nach Reihenfolge/Intervall, Wochen-/Tages-/Stundentausch bestätigt; berechtigte Rollen können eine vollständige Rotation samt erzeugten Diensten löschen, wobei der Auditverlauf erhalten bleibt; KEINE kurzfristigen Übergaben; Kennzeichnung bis zur Abrechnung, Geschäftszeiten nur Vorschlag.
...
4. Buchhaltung zeigt Leistungstexte sowie die Mitarbeiterabrechnung mit Übersicht, Kontobewegungen, Monatsabschlüssen und Export. Ein abgeschlossener Monat bleibt eingefroren. Er kann nur mit Begründung wieder geöffnet werden; Abschluss und Wiederöffnung bleiben im Auditverlauf. Später genehmigte Abwesenheitsänderungen erzeugen eine nachvollziehbare Differenzbuchung zum aktuellen Datum.
