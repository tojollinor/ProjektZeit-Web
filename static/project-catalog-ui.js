...
(()=>{
 ...
 async function open(customerId,projectId){customerFilter=String(customerId);tagFilter='';showView('projects');await render();document.dispatchEvent(new CustomEvent('pz-project-select',{detail:{id:projectId}}));}
