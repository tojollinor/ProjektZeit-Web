...
(()=>{
 ...
 async function open(customerId,projectId){customerFilter=String(customerId);tagFilter='';showView('projects');q('#page-title').textContent='Projekte';await render();document.dispatchEvent(new CustomEvent('pz-project-select',{detail:{id:projectId}}));}
 window.pzProjects={render,open};
})();
