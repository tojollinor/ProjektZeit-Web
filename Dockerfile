...
COPY app.py workday.py integrations.py database.py starface_oauth.py migrate_sqlite.py provider_lists.py starface_calls.py customer_data.py customer_runtime.py starface_directory.py provider_archive.py /app/
